...
class Util_Session {
    ...
    public static function getInstance() {
        return ( php_sapi_name() == 'cli' ) ? Util_Session_Cli::getInstance() : Util_Session_Http::getInstance();
    }
}
 ...
 */
class Util_Session_Cli implements Util_Session_Interface  {
 ...
 * @copyright http://www.crackedzone.com
 */
class Util_Session_Http implements Util_Session_Interface  {
 ...
 * @copyright http://www.crackedzone.com
 */
interface Util_Session_Interface {
    // 开启
    public function start();
    // 是否存在某个Session
    public function has($name);
